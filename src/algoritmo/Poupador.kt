...
class Poupador : ProgramaPoupador() {
    ...
    private fun calcularCusto(percepcaoVisao: IntArray, percepcaoOlfato: IntArray, acao: Acao): Int {
        return calcularCustoPercepcao(percepcaoVisao, acao) +
     ...
     * */
    private fun calcularCustoPercepcao(percepcao: IntArray, acao: Acao): Int {
        ...
        val custoMoeda = percepcao.mapIndexed { index, _percepcao ->
            // Index cima: 7, Index baixo: 2, Index esquerda: 5, Index direita: 4
